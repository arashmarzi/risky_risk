...
{
    /// <summary>
    /// The NodeList class represents a collection of nodes.  Internally, it uses a Dictionary instance to provide
    /// fast lookup via a <see cref="Node"/> class's <b>Key</b> value.  The <see cref="Graph"/> class maintains its
    /// list of nodes via this class.
    /// </summary>
    [Serializable]
	public class ContinentList : IEnumerable<Dictionary<string,Continent>>, ICloneable
    {
        // private member variables
		private Dictionary<string, Continent> data = new Dictionary<string, Continent>();

        public ContinentList() { }

		public ContinentList (Dictionary<string, Continent> data)
        {
            this.data = data;
        }
        ...
        /// </summary>
        /// <returns></returns>
		public IEnumerable<Dictionary<string,Continent>> GetEnumerator()
        {
        ...
        /// as an enumerator over the NodeList's Dictionary class, but rather than returning DictionaryEntry values,
        ...
        /// </summary>
		public class NodeListEnumerator : IEnumerator<Dictionary<string, Continent>>, IDisposable
        {
